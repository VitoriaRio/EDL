...
function inicio()
	...
	--Variavel: pontosCobra
	--Escopo: global
	--Tempo de vida: Durante todo o programa
	--Alocacao/desalocacao: A cada instante um registro é alocado e desalocado do array pontosCobra
	--						para que a cobra se movimente (é desalocado o ultimo registro da cobra 
	--						referente a cauda e alocado um novo registro na primeira posicao, que sera
	--						a nova cabeca).				
	--						Quando ha uma colisao entre algum registro presente em
	--						pontosCobra e a fruta, um novo registro é alocado e não há desalocacao
	--						da cauda.
	--						Quando ha uma colisao entre dois registros de pontosCobra (a cobra se mordeu)
	--						entao há a reinicializacao do array pontosCobra, todos os registros sao desalocados
	--						e sao alocados os primeiros 3 registros iniciais.
	pontosCobra = {
		{x = 10, y = 7},
		{x = 11, y = 7},
		{x = 12, y = 7},
